// Dados padrão para quando o Supabase não estiver configurado

export const defaultServicos = [
  { id: "1", nome: "Avaliação laudo simplificado", ordem: 1 },
  { id: "2", nome: "Laudo completo", ordem: 2 },
  { id: "3", nome: "Avaliação imóvel ou benfeitoria rural ou florestal", ordem: 3 },
  { id: "4", nome: "Levantamento topográfico", ordem: 4 },
  { id: "5", nome: "Georreferenciamento", ordem: 5 },
  { id: "6", nome: "Vistoria de obra", ordem: 6 },
];

export const defaultRegioesMG = [
  { id: "1", nome: "CENTRAL" },
  { id: "2", nome: "ZONA DA MATA" },
  { id: "3", nome: "SUL DE MINAS" },
  { id: "4", nome: "TRIANGULO" },
  { id: "5", nome: "ALTO PARAIBA" },
  { id: "6", nome: "CENTRO OESTE" },
  { id: "7", nome: "NOROESTE DE MINAS" },
  { id: "8", nome: "NORTE DE MINAS" },
  { id: "9", nome: "JEQUITINHONHA/MUCURI" },
  { id: "10", nome: "RIO DOCE" },
];
